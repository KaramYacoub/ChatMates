  ...
  return (
    <div className="rounded-xl bg-base-100 border border-base-300 hover:shadow-lg transition-all duration-200 p-0.5">
      <div className="flex flex-col items-center p-5 gap-3">
        <div className="avatar size-16 mb-2">
          <img src={friend.profilePic} alt={friend.fullName} className="rounded-full object-cover w-16 h-16 border border-base-300" />
        </div>
        <h3 className="font-semibold text-base text-center text-base-content mb-1 truncate w-full">{friend.fullName}</h3>
